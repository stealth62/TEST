...
input[type="submit" i], input[type="reset" i]:hover {
	opacity: 0.8;
}
 body{
...
<div style="font-size:0.8vw;font-family:sans-serif;position:fixed;left: -42px;bottom:0;width:100%;background-color:transparent;text-align:right;color: #0000ff47;">INBOTECH Solution <br>by Dennis Borgs</div>
</body>
</html>